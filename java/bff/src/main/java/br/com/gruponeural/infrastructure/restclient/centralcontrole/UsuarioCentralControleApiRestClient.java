package br.com.gruponeural.infrastructure.restclient.centralcontrole;
...
/** Cliente da API documentada em {@code http://localhost:3002/documentacao/} (MS Central de Controle). */
@RegisterRestClient(configKey = "centralcontrole-ms")
@Path("v1/usuario")
@Produces(MediaType.APPLICATION_JSON)
public interface UsuarioCentralControleApiRestClient {

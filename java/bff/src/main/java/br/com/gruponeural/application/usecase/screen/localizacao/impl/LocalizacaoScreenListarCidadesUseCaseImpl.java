...
@ApplicationScoped
public class LocalizacaoScreenListarCidadesUseCaseImpl implements LocalizacaoScreenListarCidadesUseCase {
    ...
    @Override
    public Uni<List<LocalizacaoItemDTO>> listar(String idEstado) {
        return localizacaoRestClient
            ...
            .invoke(response -> LogUtil
                ...
                .setValuesName("localizacaoCidades")
                .setValues(response)
                .build())
            .onFailure()
            .invoke(throwable -> LogUtil
                ...
                .setText("Erro ao listar cidades no MS Localizacao")
                .build());
    }
}
